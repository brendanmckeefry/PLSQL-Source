CREATE OR REPLACE PACKAGE BODY FT_PK_AUTOCOSTING AS
  ...
  PROCEDURE ENQUEUE_LIT(LITITENO_IN AUTOCOSTSTODO.LITITENO%TYPE, COSTCHNGTYPE_IN AUTOCOSTTYPES.COSTCHNGTYPENO%TYPE, FORMNO_IN AUTOCOSTSTODO.FORMNO%TYPE)
  IS
  BEGIN
    ENQUEUE_LITRECS(RECORD_NUMBERS(LITITENO_IN), COSTCHNGTYPE_IN, FORMNO_IN);
  END ENQUEUE_LIT;
  
  PROCEDURE ENQUEUE_DPR(DPRRECNO_IN AUTOCOSTSTODO.DPRRECNO%TYPE, COSTCHNGTYPE_IN AUTOCOSTTYPES.COSTCHNGTYPENO%TYPE, FORMNO_IN AUTOCOSTSTODO.FORMNO%TYPE)
  IS
  BEGIN
