  ...
  BEGIN
    ...
    BEGIN
        ...
        EXCEPTION
            ...
            WHEN OTHERS THEN
                NULL;
                RAISE_APPLICATION_ERROR(-20002, 'ORACLE PACKAGE -BSDL_PK_SALES - DELPRICE_NETTVALUE() - VALUE' ||CHR(13) || CHR(10) || SQLCODE || CHR(13) || CHR(10) || SQLERRM);
...
-- VERIFY THAT THIS IS A DELIVERY THAT WE CAN AMMEND
    ...
    IF V_CONT = 1 THEN
    BEGIN
        BSDL_PK_VAT.CALCDELPRICEVAT( V_ACTCSTCODE,
                        V_DELPRCPRDNO,
                        V_DLVSTKLOC,
                        V_DLVSALOFFNO,
                        V_DLVDLTRECNO,
