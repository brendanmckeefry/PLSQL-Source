    ...
    LOOP
      ...
      BEGIN 
            ...
            OR LASTUSED_REC.OPERATIONTYPE = C_UPDATE THEN
              ...
              USING 
              (SELECT PRCPRDNO, PRCREF1, PRCREF2,PRCREF3,PRCREF4,PRCREF5,PRCREF6,PRCDESCRIPTION,PRCVATCODE,PRCPRDREF,ACTIVE FROM PRDREC
            ...
            /*IF LASTUSED_REC.UNIQUERECNO = 5000
            THEN  
              RAISE NO_DATA_FOUND;
            END IF;*/
       ...
       BEGIN
                ...
                WHEN MATCHED THEN 
                   UPDATE SET HH.ALLOCPRDNO = TMPTAB.ALLOCPRDNO, HH. ALLOCSENCODE = TMPTAB.ALLOCSENCODE, HH.ALLOCPONO = TMPTAB.ALLOCPONO, HH.ALLOCLITID = TMPTAB.ALLOCLITID, 
                              ...
                              HH.LotIdentity2 = TMPTAB.LotIdentity2, HH.BuyPrce = TMPTAB.BuyPrce, HH.ListedBuyPrice = TMPTAB.ListedBuyPrice, HH.SellPrice = TMPTAB.SellPrice 
                WHEN NOT MATCHED THEN
                    INSERT(HH.ALLOCLITITEGUID, HH.ALLOCNO, HH.ALLOCPRDNO, HH.ALLOCSENCODE, HH.ALLOCPONO, HH.ALLOCLITID, HH.ALLOCSTCLOC, HH.ALLOCQTYBOX, HH.ALLOCALLOCBOX, HH.ALLOCEXPBOX,       HH.ALLOCSALOFFNO, 
                           ...
                           HH.LotIdentity2, HH.BuyPrce, HH.ListedBuyPrice, HH.SellPrice)
                    ...
                    TMPTAB.LotIdentity2, TMPTAB.BuyPrce, TMPTAB.ListedBuyPrice, TMPTAB.SellPrice);
                END;
			END IF;
      END;
          END IF;
