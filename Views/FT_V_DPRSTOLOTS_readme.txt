...
*********************************************************************************
	...
	Modified Log: ??????
	Changes Made:      
	If a DPRRECNO was for a split line and that split line was for a qty of 2 and the 2 splits came off 2 Works ORders from the same PO 
	and everything was for the same amount then this view was only returnin 1 record 
