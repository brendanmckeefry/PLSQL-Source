...
AS
   SELECT PURORD.PORRECNO,
          ...
          PRDREC.PRCREF5,
          PRDREC.PRCREF6,
          NVL (LOTPROFITSALOFF.PROFITISED,0) AS PROFITISED,
          NVL (LOTPROFITSALOFF.REOPENED,0) AS REOPENED,
     ...
     FROM PURORD
          ...
          LEFT OUTER JOIN LOTPROFITSALOFF
             ON LOTPROFITSALOFF.LITITENO = LOTITE.LITITENO
   WITH READ ONLY;

COMMENT ON TABLE FT_V_PO IS  'v1.0.2 - Internal PO View';