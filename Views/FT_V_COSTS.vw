...
AS
   SELECT ITECHG.ICHRECNO,
          ...
          NVL (ITECHG.ICHAUTHTOGLAMTBASE, 0.0) AS ICHAUTHTOGLAMTBASE,
          NVL (ITECHG.ICHAUTHTOGLAMTRAW, 0.0) AS ICHAUTHTOGLAMTRAW,          
...
COMMENT ON TABLE FT_V_COSTS IS  'v1.0.1 - Internal Cost View';
